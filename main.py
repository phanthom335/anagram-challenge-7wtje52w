    """
    Anagram Challenge 7wtje52w
    ==========================
    Zero-dependency terminal game where players explore challenges in real time.
    ...
    APP_NAME    = "Anagram Challenge 7wtje52w"
    APP_VERSION = "1.0.0"
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Zero-dependency terminal game where players explore challenges in real time.")
